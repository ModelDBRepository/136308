...
INCLUDE1=-I$(HOMECC)
IN=-I$(HOMECC)run_PRC
run_PRC:  PRC.o rk4.o Neuron.o Synapse.o Ionchannel.o GABAAsynapse.o modelGABAAsynapse.o  modelHHneuron.o HHneuron.o modelHenrysynapse.o Henrysynapse.o Calciumchannel.o AMPAsynapse.o modelAMPAsynapse.o modelGABABsynapse.o GABABsynapse.o NMDAsynapse.o modelNMDAsynapse.o mersenne.o  Couplingcurrent.o TwoDsynapse.o modelTwoDsynapse.o
	$(C++) -g -Wall -o run_PRC PRC.o rk4.o Neuron.o Synapse.o Ionchannel.o GABAAsynapse.o modelGABAAsynapse.o modelHHneuron.o HHneuron.o modelHenrysynapse.o Henrysynapse.o Calciumchannel.o AMPAsynapse.o modelAMPAsynapse.o modelGABABsynapse.o GABABsynapse.o NMDAsynapse.o modelNMDAsynapse.o mersenne.o  Couplingcurrent.o TwoDsynapse.o modelTwoDsynapse.o

PRC.o: PRC.cc 
	 $(C++)  -c  -Wall -g $(INCLUDE) PRC.cc -Wno-deprecated
