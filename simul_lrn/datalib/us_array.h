...
public:
   ...
   virtual void neigh_add(int *, int *, label_dlist<type> *, slset<tupel<int *, type> > *); 
   virtual void neigh(int *, int *, label_dlist<void *> *, int, slset<tupel<int *, type> > *); // returns set of neighbors
   virtual void neighbors(int *, slset<tupel<int*, type> > *);
};

#include "us_array.cc"                            // because of templates
